...
public class RegistrarMedico extends JFrame{
    ...
    public void mostrar(){
        ...
        FN.setBounds(5, 200, 300, 30);
        FN.setFont(new Font("Serif", Font.BOLD, 14)); 
        panel.add(FN);
        
        JTextField CFN = new JTextField();
        CFN.setBounds(5, 235, 200, 20);
        panel.add(CFN);
        
        JLabel Sexo = new JLabel("Sexo *");
        Sexo.setBounds(305, 200, 300, 30);
        Sexo.setFont(new Font("Serif", Font.BOLD, 14)); 
        panel.add(Sexo);
        
        JComboBox MSexo = new JComboBox();
        MSexo.addItem("Femenino");
        MSexo.addItem("Masculino");
        MSexo.setBounds(305, 235, 200, 20);
        ...
        JButton Registrar = new JButton("Agregar especialidad(es)");
        Registrar.setBounds(200, 580, 200, 30);
        panel.add(Registrar);
    }
}
